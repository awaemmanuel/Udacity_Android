package com.example.bigsleek.sunshine.app.service;
...
public class SunshineService extends IntentService {
    ...
    public SunshineService() {
        super("Welcome to Sunshine Service");
    }
    ...
    /**
     * Adding an alarm receiver to wake my Sunshine Service to fetch weather
     */
